exports.textTnC = () => {
    return `
Source code / bot ini merupakan program open-source (N3IB) yang ditulis menggunakan Javascript, kamu boleh follow ig ilham.bsmr kok.

Dengan menggunakan source code / bot ini maka anda setuju dengan Syarat dan Kondisi sebagai berikut:
- Source code / bot tidak menyimpan data anda di server kami paham ngentod.
...
- Source code / bot tidak boleh digunakan untuk layanan yang bertujuan/berkontribusi dalam: 
    • seks Boleh Kok asal dah hallal
    • perjudian boleh kok kalo ada uang
    • perilaku adiktif yang merugikan boleh kalo yg dirugikan diri lo sendiri
    • kejahatan boleh kok asal ga keterlaluan
    • kekerasan dalam rumah tangga ngentod jangan lupa di videoin ya
    • pembakaran hutan / penggundulan hutan boleh kok bapak lo punya hutan
    • Lah anjing kalian ga follow IG GUA BISULAN LO

Source Code BOT : https://github.com/IlhamBismar/ThePhantom
NodeJS WhatsApp library: https://github.com/open-wa/wa-automate-nodejs

Best regards, ilham bismar.`
}

exports.textMenu = (pushname) => {
    return `
Hai, ${pushname}Bangsat ! 👋️
Bot Gc Squad BarBar
link Gc : https://chat.whatsapp.com/HUW0qQ2pO1L9a8lXGV5oOt
...
Untuk janagn PC bot bagi yg cwok, kalo cwek boleh PC bot asal kenalan dulu.
Yg cwok PC bot berarti lo gay anjing.

01. *BasaBasi*
Ga usah basa basi anjing langsung aja masuk GC Squad BARBAR.
Nih link gc nya : https://chat.whatsapp.com/HUW0qQ2pO1L9a8lXGV5oOt.

02. *FollowIg*
Lah anjing cuman make bot ga follow bisulan lo anjing.
IG :ilham.bsmr.

03. *KuatTahanLama*
Jangan kebanyakan Coli lah bangsat.

04. *CewekSaveWaGuaYank*
cowok jangan PC gua anjing.
...
5. *!brainly*
Ini kalo ga salah ga bisa anjing,ngeyel amat bangsat.
...
Lah anjing ga usah basa basi gelud aja kita anak dajjal!✨`
}
...
0. *peringatan/penting*
69 adalah stayle yg sering di mainkan bintang bokep.
...
1. Saweria: https://saweria.co/IlhamBismar
2. Trakteer: https://trakteer.id/Dark-Knight
3. Pesan : Selamat bersenang" Bangsat
4. Pesan : Jangan PC Gua bangsat, kalo cwek gpp
5. Follow ig : ilham.bsmr 
6. Join Gc squad BarBar : https://chat.whatsapp.com/HUW0qQ2pO1L9a8lXGV5oOt
7. Gua lagi nyari cewek cakep, kalo ada pc ya
Donasi akan digunakan untuk pengembangan dan menikahi janda muda.
